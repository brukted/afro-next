...
layout(set = 0, binding = 0) uniform FxParams {
    ivec4 blendModeBlock;
} params;
...
#define Background sampler2D(BackgroundTex, linearSampler)
#define blendMode params.blendModeBlock.x
